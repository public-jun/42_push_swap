...
/*   Updated: 2021/05/08 18:20:04 by jnakahod         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	add_value_to_pair(t_info *info, int value,
			int i, t_list_group *list_group);
...
void	exec_s_r_and_add_instr_node(void (*f)(t_num_list_node *),
			t_num_list_node *stack, char *instr,
...
** sort_only_3_node
*/
void	sort_only_three(t_num_list_node *stack,
			t_list_group *list_group, t_info *info);
void	sort_only_three_case1(t_num_list_node *stack,
			t_list_group *list_group, t_info *info);
void	sort_only_three_case2(t_num_list_node *stack,
			t_list_group *list_group, t_info *info);
void	sort_only_three_case3(t_num_list_node *stack,
			t_list_group *list_group, t_info *info);
void	sort_only_three_case4(t_num_list_node *stack,
			t_list_group *list_group, t_info *info);
void	sort_only_three_case5(t_num_list_node *stack,
			t_list_group *list_group, t_info *info);
/*
** sort_less6
*/
